...
function validationillegalCharacter(field, rules, i, options){
	var str = field.val();
	var non_special_char_regexp = "\",/,>,<,sp_,xp_,\\,dir ,cmd ,^,+,$,',#,@,￥,(,),[,],{,},%,copy ,format ,and ,exec ,insert ,select ,delete ,update ,count ,*,%,_,chr ,mid ,master ,truncate ,char ,declare ";
